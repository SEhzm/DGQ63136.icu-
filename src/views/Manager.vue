	...
	<div>
		...
		>
			<div style="flex: 1">
				...
				>
					<a
						href="https://www.douyu.com/63136"
						target="_blank"
						style="display: block; width: 370px;height: 50px;"
					>
						<img
							src="https://pic.imgdb.cn/item/6607ee8f9f345e8d03ae3a77.png"
							alt="大狗头"
							style="height: 40px; float: left; margin: 5px;"
						/>

						<p style="color: #ff552e;font-size: 36px;font-weight: bold;float: right;">斗鱼63136弹幕收集</p>
					</a>
					<div
						style="
							display: flex;
					...
					>
						<el-button
							type="primary"
							@click="complaintButton"
							style="margin-right: 10px"
							><span>建议/提交BUG</span></el-button
						>
						<a
							href="https://yuba.douyu.com/user/main/lOdEpeOJzwnR"
							target="_blank"
						>
							<img
								src="@/assets/imgs/douyu.jpg"
								alt="douyu"
								style="margin-right: 15px"
							/>
						</a>
						<a
							href="https://github.com/SEhzm/DGQ63136.icu-"
							target="_blank"
						>
							<img
